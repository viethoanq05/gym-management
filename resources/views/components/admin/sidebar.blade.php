    ...
    <div class="relative flex h-full flex-col px-5 py-6 overflow-y-auto admin-scrollbar">
        ...
        <div class="mb-8 flex items-center justify-between gap-3">
            <div class="flex items-center gap-3">
                ...
                <div>
                    <p class="text-[0.65rem] uppercase tracking-[0.2em] text-slate-500 font-medium">IRON CORE</p>
        ...
        <nav class="space-y-1">
            ...
            ['label' => 'Hội viên', 'route' => 'admin.members.index', 'icon' => '
            <path d="M17 21v-2a4 4 0 00-4-4H5a4 4 0 00-4 4v2" />
            <circle cx="9" cy="7" r="4" />
            <path d="M23 21v-2a4 4 0 00-3-3.87" />
            <path d="M16 3.13a4 4 0 010 7.75" />'],
            ['label' => 'Nhân viên', 'route' => 'admin.staff.index', 'icon' => '
            <path d="M20 21v-2a4 4 0 00-4-4H8a4 4 0 00-4 4v2" />
            <circle cx="12" cy="7" r="4" />'],
            ['label' => 'Huấn luyện viên', 'route' => 'admin.trainers.index', 'icon' => '
            <path d="M14 2H6a2 2 0 00-2 2v16a2 2 0 002 2h12a2 2 0 002-2V8z" />
            <polyline points="14 2 14 8 20 8" />
            <line x1="16" y1="13" x2="8" y2="13" />
            <line x1="16" y1="17" x2="8" y2="17" />'],
            ['label' => 'Gói tập', 'route' => 'admin.packages.index', 'icon' => '
            <rect x="1" y="3" width="15" height="13" rx="2" ry="2" />
            <path d="M16 8h2a2 2 0 012 2v6a2 2 0 01-2 2h-2" />
            <line x1="6" y1="7" x2="12" y2="7" />
            <line x1="6" y1="11" x2="10" y2="11" />'],
            ['label' => 'Giao dịch', 'route' => 'admin.payments.index', 'icon' => '
            <line x1="12" y1="1" x2="12" y2="23" />
            <path d="M17 5H9.5a3.5 3.5 0 000 7h5a3.5 3.5 0 010 7H6" />'],
            ['label' => 'Đặt lịch', 'route' => 'admin.bookings.index', 'icon' => '
