<header class="flex items-center justify-between bg-white px-4 py-4 sm:px-6 border-b">
    ...
    <div class="relative inline-flex items-center gap-3 rounded-2xl border border-slate-200 bg-white px-4 py-2 shadow-sm ml-auto">
        ...
        <div class="relative inline-flex items-center gap-3">
            <button class="inline-flex h-11 items-center gap-3 rounded-2xl bg-slate-50 px-4 text-sm font-medium text-slate-700 transition hover:bg-slate-100">
